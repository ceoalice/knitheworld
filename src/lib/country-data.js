...
import {data as isoCountryRawData} from 'iso-3166-2';
...
const countryOptions = (startingCountryInfo, valueField) => (
...
const lookupCountryByCode = countryCode => (
    countryInfo.find(country => country.code === countryCode)
);

const lookupCountryByName = countryName => (
 ...
 */
const dupeCommonCountries = (startingCountryInfo, commonCountryCodes) => {
 ...
 * ]
 */
const subdivisionOptions = Object.keys(isoCountryRawData).reduce((subByCountry, code) => {
